    ...
    <div id="page_single_wrapper" class="col-12">
        <div class="row">
          <div class="col-12 mb-3 ml-2"><button class="btn btn-info btn-sm" onclick="history.back()" style="pointer: cursor">< back</button></div>
            ...
            <div class="col-10">
                <div id="single_page_header" class="d-flex">
                    <div class="col">
            ...
            <div class="col-10">
                <div class="single-page-attending-widget">
                    ...
                    <?php } ?>
                    <span class="single-page-attending-count">| <?php echo attending_users_count(get_the_ID()) ?> interested</span>
                </div>
            </div>
        </div>
        <hr>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row single_page_box">
                        ...
                        <div id="share-area" class="col">
                            ...
                            <a class="resp-sharing-button__link" href="https://twitter.com/intent/tweet/?text=<?php echo rawurlencode("I am attending Barcamp Bangalore 2022 by @barcampbng! Session titled \"" . get_the_title() . "\" looks interesting. More info at " . get_permalink() . " #barcampblr @barcampbng ");?>" target="_blank" aria-label="">
                            ...
                            <a class="resp-sharing-button__link" href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo urlencode(get_permalink()); ?>&amp;title=<?php echo rawurlencode("I am attending Barcamp Bangalore 2022! Session titled \"" . get_the_title() . "\" looks interesting. More info at " . get_permalink()); ?>&amp;summary=<?php echo rawurlencode("I am attending Barcamp Bangalore 2022! Session titled \"" . get_the_title() . "\" looks interesting. More info at " . get_permalink()); ?>&amp;source=<?php echo urlencode(get_permalink()); ?>" target="_blank" aria-label="">
                            ...
                            <a class="resp-sharing-button__link" href="whatsapp://send?text=<?php echo rawurlencode("I am attending Barcamp Bangalore 2022! Session titled \"" . get_the_title() . "\" looks interesting. More info at " . get_permalink()); ?>%20<?php echo urlencode(get_permalink()); ?>" target="_blank" aria-label="">
                            ...
                            <a class="resp-sharing-button__link" href="https://telegram.me/share/url?text=<?php echo rawurlencode("I am attending Barcamp Bangalore 2022! Session titled \"" . get_the_title() . "\" looks interesting. More info at " . get_permalink()); ?>&amp;url=<?php echo urlencode(get_permalink()); ?>" target="_blank" aria-label="">
