                ...
                <div class="container-fluid">
                    ...
                    <div class="row single_page_box">
                        ...
                        <div id="share-area" class="col">
                            ...
                            <a class="resp-sharing-button__link" href="https://twitter.com/intent/tweet/?text=<?php echo rawurlencode("I am attending Barcamp Bangalore 2022! Session titled \"" . get_the_title() . "\" looks interesting. More info at " . get_permalink() . ". #bcb2022 @barcampbng.");?>" target="_blank" aria-label="">
                            ...
                            <a class="resp-sharing-button__link" href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo urlencode(get_permalink()); ?>&amp;title=<?php echo rawurlencode("I am attending Barcamp Bangalore 2022! Session titled \"" . get_the_title() . "\" looks interesting. More info at " . get_permalink() . ". #bcb2022"); ?>&amp;summary=<?php echo rawurlencode("I am attending Barcamp Bangalore 2022! Session titled \"" . get_the_title() . "\" looks interesting. More info at " . get_permalink() . ". #bcb2022."); ?>&amp;source=<?php echo urlencode(get_permalink()); ?>" target="_blank" aria-label="">
