                ...
                <div class="container-fluid">
                    ...
                    <div class="row single_page_box">
                        ...
                        <div id="share-area" class="col">
                            ...
                            <a class="resp-sharing-button__link" href="https://twitter.com/intent/tweet/?text=<?php echo rawurlencode("I am attending Barcamp Bangalore Spring 2019 and session titled \"" . get_the_title() . "\", more info at " . get_permalink()); ?>" target="_blank" aria-label="">
