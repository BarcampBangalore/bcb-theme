                ...
                <div class="container-fluid">
                    ...
                    <div class="row single_page_box">
                        ...
                        <div id="share-area" class="col">
                            ...
                            <a class="resp-sharing-button__link" href="https://twitter.com/intent/tweet/?text=<?php echo rawurlencode("I am attending Barcamp Bangalore Monsoon 2019 and session titled \"" . get_the_title() . "\", more info at " . get_permalink() . " #barcampblr @barcampbng ");?>" target="_blank" aria-label="">
                            ...
                            <a class="resp-sharing-button__link" href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo urlencode(get_permalink()); ?>&amp;title=<?php echo rawurlencode("I am attending Barcamp Bangalore Monsoon 2019 and session titled \"" . get_the_title() . "\", more info at " . get_permalink()); ?>&amp;summary=<?php echo rawurlencode("I am attending Barcamp Bangalore Monsoon 2019 and session titled \"" . get_the_title() . "\", more info at " . get_permalink()); ?>&amp;source=<?php echo urlencode(get_permalink()); ?>" target="_blank" aria-label="">
                            ...
                            <a class="resp-sharing-button__link" href="whatsapp://send?text=<?php echo rawurlencode("I am attending Barcamp Bangalore Monsoon 2019 and session titled \"" . get_the_title() . "\", more info at " . get_permalink()); ?>%20<?php echo urlencode(get_permalink()); ?>" target="_blank" aria-label="">
                            ...
                            <a class="resp-sharing-button__link" href="https://telegram.me/share/url?text=<?php echo rawurlencode("I am attending Barcamp Bangalore Monsoon 2019 and session titled \"" . get_the_title() . "\", more info at " . get_permalink()); ?>&amp;url=<?php echo urlencode(get_permalink()); ?>" target="_blank" aria-label="">
