            ...
            <div class="col-12">
                ...
                <!-- Button code -->
                    <div title="Add to Calendar" class="addeventatc">
                        Add to Calendar
                        <span class="start">02/02/2019 08:00 AM</span>
                        <span class="end">02/02/2019 6:00 PM</span>
                        <span class="timezone">India/Kolkata
                    </span>
                        <span class="title">Barcamp Bangalore Spring 2019</span>
                        <span class="description">Barcamp Bangalore Spring 2019</span>
                        <span class="location">Dayanand Sagar University, School of Engineering, Kudlu Gate (Not Kumaraswamy Layout), Bangalore</span>
                    </div>
