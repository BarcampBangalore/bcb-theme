        ...
        <div id="home_sharearea" class="row">
            <div class="col-12">
                <strong>Spread the word :</strong>
                    ...
                    <a class="resp-sharing-button__link" href="https://twitter.com/intent/tweet/?text=<?php echo rawurlencode("I am attending Barcamp Bangalore Spring 2019 - you might find the topics discussed interesting. More info at " . get_permalink() . " #barcampblr @barcampbng")?>" target="_blank" aria-label="">
