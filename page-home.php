...
<div class="container marketing">
  ...
  <div class="row featurette">
    <div class="col-md-7 order-md-2">
      ...
      <p class="lead">
        Sessions are given on a variety of topics, and the day is created collaboratively – built by you
  ...
  <div class="row featurette">
    <div class="col-md-7">
      ...
      <p class="lead">
        Sessions include topics ranging from design, technology, creativity, to entrepreneurship and lifestyle.
